...
from utils.dataset_parsing import realdata_spikes as rd
import numpy as np

from utils.dataset_parsing.realdata_spikes import separate_by_channel, get_data_from_channel, \
    find_waverform_files
...
spikes_per_channel = rd.parse_spktwe_file(DATASET_PATH)
